...
# One-sentence, founder-perspective description per stage (shown next to the
# stage selector; the fuller STAGE_GUIDANCE notes stay in reports/help).
STAGE_SHORT = {
    "Ideation": "You are exploring an idea. Nothing is built or sold yet.",
    "Validation / MVP": "You are testing a first version (MVP) with early "
                        "users or pilot customers.",
    "Early commercialization": "You have your first paying customers and "
                               "initial operational data.",
    "Growth": "You are scaling up, with growing scrutiny from investors "
              "and regulators.",
}
